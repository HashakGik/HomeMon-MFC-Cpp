...
public:
	...
	Radar(CImage *img, int cx, int cy, int radius, int rings, int size, fill_t fill, int min, int max, uint8_t fgR, uint8_t fgG, uint8_t fgB, uint8_t bgR, uint8_t bgG, uint8_t bgB);
