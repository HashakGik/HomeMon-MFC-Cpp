...
public:
	...
	Dial(CImage *img, int cx, int cy, double arc, double phase, int radius, int ticks, direction_t dir, int min, int max, uint8_t fgR, uint8_t fgG, uint8_t fgB, uint8_t bgR, uint8_t bgG, uint8_t bgB);
